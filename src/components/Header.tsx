        ...
        <Link to="/">
          <EuiText>
            {/* <h2 style={{ padding: "0 1vw" }}>
              <EuiTextColor color="#FFFFFF">Connect...</EuiTextColor>
            </h2> */}
            <h2 style={{ padding: "0 1vw", display: "flex", alignItems: "center" }}>
              <img src="https://brandeps.com/icon-download/V/Video-call-icon-vector-03.svg" alt="Logo" style={{ marginRight: "10px", width: "50px", height: "80px", paddingTop: "25px" }} />
              <EuiTextColor color="#FFFFFF">Connect...</EuiTextColor>
            </h2>
          </EuiText>
        </Link>,
